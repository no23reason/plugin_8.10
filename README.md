...
2.  Develop your plugin code in `src/dp_tiger_v_810_alpha`

    The `src/dp_tiger_v_810_alpha/Plugin.tsx` is the main plugin file where you have to register all
    your custom content. However, you can create as many new files as you want under the `src/dp_tiger_v_810_alpha`
...
5.  Add plugin to one or more workspaces: `npm run add-plugin -- <url>`
    ...
    Run the `npm run add-plugin -- "https://your.hosting/pluginDirOfYourChoice/dp_tiger_v_810_alpha.js"` to
...
6.  Use plugin on a dashboard: `npm run link-plugin -- <plugin-object-id>`
    ...
    If your plugin supports parameterization (see [src/dp_tiger_v_810_alpha](./src/dp_tiger_v_810_alpha/Plugin.tsx)) and
...
This project is setup so that all your custom code must be self-contained in the [src/dp_tiger_v_810_alpha](./src/dp_tiger_v_810_alpha) directory.

The [src/dp_tiger_v_810_alpha\_engine](./src/dp_tiger_v_810_alpha_engine) and [src/dp_tiger_v_810_alpha\_entry](./src/dp_tiger_v_810_alpha_entry) directories contain essential plugin boilerplate.
...
You can modify minEngineVersion and maxEngineVersion properties in `src/dp_tiger_v_810_alpha\_entry/index`.
