...
export var convertKpi = function (kpi) {
    var _a = kpi.kpi, content = _a.content, _b = _a.content, dateDataSet = _b.dateDataSet, ignoreDashboardFilters = _b.ignoreDashboardFilters, drillTo = _b.drillTo, _c = _a.meta, identifier = _c.identifier, uri = _c.uri, title = _c.title, summary = _c.summary;
    return {
        type: "kpi",
        ref: uriRef(uri),
