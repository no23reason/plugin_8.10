 ...
 * @internal
 */
export function generateHeaderMenuItemsGroups(featureFlags, workspacePermissions, hasAnalyticalDashboards, workspaceId, dashboardId, tabId, hasNoDataSet, backendSupportsDataItem, backendSupportsCsvUploader, hasMeasures, hasManage) {
    ...
    if (hasManage === void 0) { hasManage = true; }
    if (!workspaceId) {
        return [];
    }
    ...
    var manageItemsGroup = createManageItemsGroup(workspacePermissions, workspaceRef, workspaceId, hasManage);
