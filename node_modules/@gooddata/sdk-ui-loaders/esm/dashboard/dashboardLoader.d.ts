 ...
 * @public
 */
export declare type DashboardPluginsLoader = (ctx: DashboardContext, dashboard: IDashboardWithReferences, options?: IDashboardPluginsLoaderOptions) => Promise<LoadedPlugin[]>;
/**
 * @public
 */
