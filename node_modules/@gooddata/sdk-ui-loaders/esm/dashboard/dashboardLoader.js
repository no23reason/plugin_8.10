...
var DashboardLoader = /** @class */ (function () {
    function DashboardLoader(config) {
        ...
        this.load = function (options) { return __awaiter(_this, void 0, void 0, function () {
            var _a, backend, dashboard, filterContextRef, dashboardRef, _b, workspace, clientWorkspace, dashboardWithPlugins, ctx, pluginsAreValid, externalPluginLoaded, beforeExternalPluginLoaded, _c, engine, plugins, extensionProps, config, dashboardConfig, props, DashboardComponent;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        invariant(dashboardRef, "DashboardLoader is not configured with a reference to dashboard that it should load.");
                    ...
                    case 4:
                        ...
                        props = __assign(__assign(__assign(__assign({}, this.baseProps), { config: dashboardConfig }), extensionProps), { workspace: workspace, dashboard: dashboardWithPlugins.dashboard });
