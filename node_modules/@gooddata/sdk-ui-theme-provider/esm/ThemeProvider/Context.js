...
var ThemeIsLoadingContext = React.createContext(undefined);
...
export var ThemeContextProvider = function (_a) {
    var children = _a.children, theme = _a.theme, themeIsLoading = _a.themeIsLoading;
 ...
 * @public
 */
export var useTheme = function (theme) {
    var themeFromContext = React.useContext(ThemeContext);
 ...
 * @public
 */
export var useThemeIsLoading = function () {
...
export function withThemeObject(Component) {
    var ComponentWithInjectedThemeObject = function (props) {
        return (React.createElement(ThemeContext.Consumer, null, function (theme) { var _a; return React.createElement(Component, __assign({}, props, { theme: (_a = props.theme) !== null && _a !== void 0 ? _a : theme })); }));
    };
...
export function withThemeIsLoading(Component) {
    var ComponentWithInjectedThemeIsLoading = function (props) {
        return (React.createElement(ThemeIsLoadingContext.Consumer, null, function (themeIsLoading) { return React.createElement(Component, __assign({ themeIsLoading: themeIsLoading }, props)); }));
    };
