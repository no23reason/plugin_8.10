...
import { IVisualizationDescriptor, PluggableVisualizationFactory } from "../../../interfaces/VisualizationDescriptor";
...
export declare class BarChartDescriptor extends BaseChartDescriptor implements IVisualizationDescriptor {
    ...
    applyDrillDown(source: IInsight, drillDownContext: IDrillDownContext): IInsight;
