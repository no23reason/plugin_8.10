...
var PluggableComboChart = /** @class */ (function (_super) {
    ...
    PluggableComboChart.prototype.getDefaultAndAvailableSort = function (buckets, properties) {
        var _a, _b;
        ...
        if (!isEmpty(viewBy) && (!isEmpty(measures) || !isEmpty(secondaryMeasures))) {
            ...
            return {
                ...
                availableSorts: [
                    newAvailableSortsGroup(viewBy[0].localIdentifier, mergedMeasures.map(function (m) { return m.localIdentifier; }), true, canSortStackTotal || mergedMeasures.length > 1),
                ],
            };
        }
        return {
    ...
    PluggableComboChart.prototype.getSortConfig = function (referencePoint) {
        ...
        var _a = this.getDefaultAndAvailableSort(buckets, properties), defaultSort = _a.defaultSort, availableSorts = _a.availableSorts;
