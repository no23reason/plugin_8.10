...
import { insightHasMeasures, insightMeasures, } from "@gooddata/sdk-model";
...
var PluggableBaseChart = /** @class */ (function (_super) {
    ...
    PluggableBaseChart.prototype.getExecution = function (options, insight, executionFactory) {
        ...
        return (_a = (_b = executionFactory
            ...
            .withSorting.apply(_a, createSorts(this.type, insight, canSortStackTotalValue(insight, supportedControls), this.featureFlags.enableChartsSorting)).withDateFormat(dateFormat)
