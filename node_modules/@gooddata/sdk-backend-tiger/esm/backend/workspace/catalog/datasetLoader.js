        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, MetadataUtilities.getAllPagesOf(client, client.entities.getAllEntitiesAttributes, params, { query: { include: includeObjects.join(",") } }).then(MetadataUtilities.mergeEntitiesResults)];
                case 1:
                    attributes = _a.sent();
                    catalogItems = [];
                    if (loadAttributes) {
