...
function loadAttributes(client, workspaceId) {
    return MetadataUtilities.getAllPagesOf(client, client.entities.getAllEntitiesAttributes, { workspaceId: workspaceId }, { query: { include: "labels" } })
