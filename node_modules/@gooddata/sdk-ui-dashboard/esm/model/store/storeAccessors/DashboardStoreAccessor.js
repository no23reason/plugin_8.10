 ...
 * @public
 */
var DashboardStoreAccessor = /** @class */ (function () {
    function DashboardStoreAccessor(selector, dispatch) {
        var _this = this;
        /**
         * Returns current selector for the dashboard's component state.
         */
        this.getDashboardSelect = function () {
            invariant(_this.selectorEvaluator, "DashboardStoreAccessor selectorEvaluator is not initialized");
            return _this.selectorEvaluator;
        };
        /**
         * Setter for the dashboard's component state selector.
         * @param selectorEvaluator - dashboardSelectorEvaluator
         */
        this.setSelector = function (selectorEvaluator) {
            _this.selectorEvaluator = selectorEvaluator;
        };
        /**
         * Returns current dispatch object for the dashboard component state.
         */
        this.getDashboardDispatch = function () {
            invariant(_this.dispatch, "DashboardStoreAccessor dispatch is not initialized");
         ...
         */
        this.setDispatch = function (dispatch) {
            _this.dispatch = dispatch;
        };
        /**
         * Checks if {@link DashboardStoreAccessor} is fully initialized.
         */
        this.isDashboardStoreAccessorInitialized = function () {
            return !!_this.selectorEvaluator && !!_this.dispatch;
        };
        /**
         ...
         */
        this.setSelectAndDispatch = function (state, dispatch) {
            var dashboardSelect = function (select) { return select(state); };
            _this.setSelector(dashboardSelect);
            _this.setDispatch(dispatch);
        };
        this.selectorEvaluator = selector;
        this.dispatch = dispatch;
    }
    return DashboardStoreAccessor;
}());
export { DashboardStoreAccessor };
