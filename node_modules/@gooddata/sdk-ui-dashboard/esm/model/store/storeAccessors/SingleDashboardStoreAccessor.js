 ...
 */
var DASHBOARD = serializeObjRef(idRef("SingleDashboardStoreAccessor_mock_dashboard_id"));
/**
 ...
 * @public
 */
var SingleDashboardStoreAccessor = /** @class */ (function () {
    function SingleDashboardStoreAccessor() {
    }
    /**
     * Returns a selector for current dashboard.
     */
    SingleDashboardStoreAccessor.getDashboardSelect = function () {
     ...
     */
    SingleDashboardStoreAccessor.getDashboardDispatch = function () {
     ...
     */
    SingleDashboardStoreAccessor.getOnChangeHandler = function () {
     ...
     */
    SingleDashboardStoreAccessor.clearAccessor = function () {
     ...
     */
    SingleDashboardStoreAccessor.isAccessorInitialized = function () {
        return DashboardStoreAccessorRepository.isAccessorInitializedForDashboard(DASHBOARD);
    };
    return SingleDashboardStoreAccessor;
}());
export { SingleDashboardStoreAccessor };
