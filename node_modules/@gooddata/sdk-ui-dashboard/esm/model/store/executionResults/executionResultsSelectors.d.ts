 ...
 * @alpha
 */
export declare const selectIsExecutionResultExportableToCsvByRef: (ref: ObjRef) => import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res1: boolean, res2: boolean, res3: boolean, res4: import("@gooddata/sdk-backend-spi").ISettings) => boolean>;
/**
 * @alpha
 */
export declare const selectIsExecutionResultExportableToXlsxByRef: (ref: ObjRef) => import("@reduxjs/toolkit").OutputSelector<DashboardState, boolean, (res1: boolean, res2: boolean, res3: import("@gooddata/sdk-backend-spi").ISettings) => boolean>;
