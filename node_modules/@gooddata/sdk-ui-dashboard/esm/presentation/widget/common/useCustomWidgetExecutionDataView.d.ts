import { DataViewFacade, GoodDataSdkError, IExecutionConfiguration, UseCancelablePromiseState } from "@gooddata/sdk-ui";
 ...
 * @public
 */
export declare function useCustomWidgetExecutionDataView({ widget, execution, }: IUseCustomWidgetExecutionDataViewConfig): UseCancelablePromiseState<DataViewFacade, GoodDataSdkError>;
