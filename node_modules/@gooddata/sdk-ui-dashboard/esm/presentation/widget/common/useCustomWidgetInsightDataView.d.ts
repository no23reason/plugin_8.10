 ...
 * @public
 */
export declare function useCustomWidgetInsightDataView({ widget, insight, }: IUseCustomWidgetInsightDataViewConfig): UseCancelablePromiseState<DataViewFacade, GoodDataSdkError>;
