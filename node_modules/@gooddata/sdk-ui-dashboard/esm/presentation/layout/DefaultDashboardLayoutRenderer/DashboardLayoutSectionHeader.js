...
export var DashboardLayoutSectionHeader = function (props) {
    var title = props.title, description = props.description, renderBeforeHeader = props.renderBeforeHeader, renderHeader = props.renderHeader;
        ...
        React.createElement("div", { className: "gd-fluid-layout-row-header-container" }, renderHeader !== null && renderHeader !== void 0 ? renderHeader : (React.createElement("div", { className: "gd-row-header-view" },
            title && (React.createElement("div", { className: "gd-row-header-title-wrapper" },
                React.createElement("span", { className: "title" },
                    React.createElement(Typography, { tagName: "h2", className: "s-fluid-layout-row-title" }, title)))),
            description && React.createElement(DashboardLayoutSectionHeaderDescription, { description: description }))))));
};
