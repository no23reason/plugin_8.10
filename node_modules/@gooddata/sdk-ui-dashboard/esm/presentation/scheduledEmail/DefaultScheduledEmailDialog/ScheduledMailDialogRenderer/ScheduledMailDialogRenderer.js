...
import { uriRef, objRefToString } from "@gooddata/sdk-model";
...
var ScheduledMailDialogRendererUI = /** @class */ (function (_super) {
    ...
    function ScheduledMailDialogRendererUI(props) {
        ...
        _this.renderFiltersMessage = function () {
            var _a = _this.props, enableWidgetExportScheduling = _a.enableWidgetExportScheduling, hasDefaultFilters = _a.hasDefaultFilters;
        ...
        _this.getAttachments = function (dashboard) {
            ...
            var widgetsRefStringToUriRefMap = _this.props.dashboardInsightWidgets.reduce(function (acc, widget) {
                var _a;
                return (__assign((_a = {}, _a[objRefToString(widget)] = uriRef(widget.uri), _a), acc));
            }, {});
        ...
        _this.state = {
            ...
            attachments: {
                ...
                widgetsSelected: props.dashboardInsightWidgets.reduce(function (acc, widget) {
                    var _a;
                    return (__assign(__assign({}, acc), (_a = {}, _a[objRefToString(widget)] = false, _a)));
                }, {}),
                configuration: {
                    format: "csv",
                    mergeHeaders: true,
    ...
    ScheduledMailDialogRendererUI.prototype.render = function () {
        ...
        var headingTranslationId = this.props.enableWidgetExportScheduling
        ...
        return (React.createElement(Overlay, { alignPoints: alignPoints, className: "gd-schedule-email-dialog-overlay", isModal: true, positionType: "fixed", onAlign: this.onAlign },
            React.createElement(ConfirmDialogBase, { className: "gd-schedule-email-dialog s-gd-schedule-email-dialog", isPositive: true, headline: intl.formatMessage({ id: headingTranslationId }), cancelButtonText: intl.formatMessage({ id: "cancel" }), submitButtonText: intl.formatMessage({ id: "dialogs.schedule.email.submit" }), isSubmitDisabled: !this.state.isValidScheduleEmailData, submitOnEnterKey: false, onCancel: onCancel, onSubmit: this.onScheduleDialogSubmit },
