...
import { changeAttributeFilterSelection, changeDateFilterSelection, clearDateFilterSelection, exportDashboardToPdf, renameDashboard, selectCanCreateAnalyticalDashboard, selectCanCreateScheduledMail, selectCanExportReport, selectDashboardRef, selectDashboardShareInfo, selectDashboardTitle, selectEnableKPIDashboardExportPDF, selectEnableKPIDashboardSchedule, selectFilterContextFilters, selectIsLayoutEmpty, selectIsReadOnly, selectIsSaveAsDialogOpen, selectMenuButtonItemsVisibility, selectPersistedDashboard, uiActions, useDashboardCommandProcessing, useDashboardDispatch, useDashboardSelector, } from "../../../model";
...
import { ScheduledEmailDialogProvider, useScheduledEmailDialogProvider, } from "./ScheduledEmailDialogProvider";
...
export var DashboardHeader = function () {
    ...
    var _b = useTopBar(), title = _b.title, onTitleChanged = _b.onTitleChanged, onShareButtonClick = _b.onShareButtonClick, shareInfo = _b.shareInfo;
    ...
    var defaultOnScheduleEmailing = useScheduledEmailDialogProvider().defaultOnScheduleEmailing;
    var dispatch = useDashboardDispatch();
    ...
    var defaultMenuItems = useMemo(function () {
        ...
        var isSaveAsVisible = canCreateDashboard && ((_a = menuButtonItemsVisibility.saveAsNewButton) !== null && _a !== void 0 ? _a : false);
        var isSaveAsDisabled = isEmptyLayout || !dashboardRef || isReadOnly;
        var isPdfExportVisible = canExportReport &&
            isKPIDashboardExportPDFEnabled &&
            ((_b = menuButtonItemsVisibility.pdfExportButton) !== null && _b !== void 0 ? _b : true);
        var isScheduledEmailingVisible = !isReadOnly &&
            canCreateScheduledMail &&
            isScheduledEmailingEnabled &&
            ((_c = menuButtonItemsVisibility.scheduleEmailButton) !== null && _c !== void 0 ? _c : true);
        return [
            {
                type: "button",
