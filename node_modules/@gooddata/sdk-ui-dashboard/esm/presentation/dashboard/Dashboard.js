...
import { BackendProvider, ErrorComponent as DefaultError, LoadingComponent as DefaultLoading, useBackendStrict, useWorkspaceStrict, WorkspaceProvider, } from "@gooddata/sdk-ui";
...
import { changeFilterContextSelection, DashboardStoreProvider, selectDashboardLoading, selectFilterBarExpanded, selectFilterBarHeight, selectLocale, useDashboardSelector, useDispatchDashboardCommand, } from "../../model";
...
var useDashboard = function (props) {
    var dashboard = props.dashboard, DashboardAttributeFilterComponentProvider = props.DashboardAttributeFilterComponentProvider, WidgetComponentProvider = props.WidgetComponentProvider, InsightComponentProvider = props.InsightComponentProvider, InsightMenuButtonComponentProvider = props.InsightMenuButtonComponentProvider, insightMenuItemsProvider = props.insightMenuItemsProvider, InsightMenuComponentProvider = props.InsightMenuComponentProvider, KpiComponentProvider = props.KpiComponentProvider;
...
export var Dashboard = function (props) {
    ...
    var _q = useDashboard(props), backend = _q.backend, workspace = _q.workspace, hasThemeProvider = _q.hasThemeProvider, dashboardOrRef = _q.dashboardOrRef, attributeFilterProvider = _q.attributeFilterProvider, widgetProvider = _q.widgetProvider, insightProvider = _q.insightProvider, insightMenuButtonProvider = _q.insightMenuButtonProvider, insightMenuProvider = _q.insightMenuProvider, kpiProvider = _q.kpiProvider;
    ...
    if (props.theme || (!hasThemeProvider && !props.disableThemeLoading)) {
        return (React.createElement(ThemeProvider, { theme: props.theme, modifier: (_p = props.themeModifier) !== null && _p !== void 0 ? _p : defaultDashboardThemeModifier, backend: backend, workspace: workspace }, dashboardRender));
    }
